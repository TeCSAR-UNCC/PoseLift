...
4-**Camera Views**: 6 indoor cameras (C1 to C6) from various aisles and locations in a local retail store in the USA. ![Camera](https://github.com/TeCSAR-UNCC/PoseLift/blob/main/Samples/Cameraviews.pdf)
